...
sudo ./benchmark.sh sort_merge $((1500+ 8*(1<<28)/4096))  taskset -c $CPU ./cpp/sort_merge 42 $((1<<28)) bitonic_merge false
sudo ./benchmark.sh sort  $((1500+ 8*(1<<25)/4096))  taskset -c $CPU ./cpp/sort 42 $((1<<25)) bitonic_sort false
