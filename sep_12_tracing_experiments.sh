...
sudo US_SIZES="8 16 32 64 128 256 512 1024 2048 4096 8192 16384 32768 65536" RATIOS="30" ./trace_benchmark.sh mmult_eigen 101394 taskset -c 0 ./cpp/mmult_eigen 4 4096 mat
